  ...
  if (isMobile) {
    return (
      <div className="min-h-screen flex flex-col bg-background overflow-x-hidden">
        ...
        {/* Aumentando o padding para pt-24 no mobile */}
  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden">
      ...
      >
        ...
        <header 
          className="fixed top-0 z-20 flex h-16 items-center gap-4 border-b bg-background px-6"
          style={{ 
            left: isCollapsed ? sidebarWidthMd : sidebarWidth,
            width: `calc(100% - ${isCollapsed ? sidebarWidthMd : sidebarWidth})` // Calcula a largura restante
          }}
        >
          {/* Botão de Toggle */}
          <Button 
        ...
        {/* Aumentando o padding para pt-28 no desktop */}
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-4 lg:p-4 bg-background animate-fade-in pt-28">
          {children}
        </main>
      </div>
    </div>
