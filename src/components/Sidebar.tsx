    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          // Estilos para estado colapsado: centraliza, usa px-4 para alinhamento visual
          isCollapsed ? "justify-center w-full px-4 gap-0" : "px-3 gap-3",
            ...
            <Collapsible defaultOpen={isProductsServicesOpen} disabled={isCollapsed}>
              <CollapsibleTrigger 
                className={cn(
                  ...
                  isCollapsed ? "justify-center px-4" : "px-3" // <-- Alterado para px-4
                )}
              >
