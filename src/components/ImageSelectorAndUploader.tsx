...
import { useStorageImages } from '@/integrations/supabase/storage';
import { useTranslation } from 'react-i18next';

interface ImageSelectorAndUploaderProps {
...
const ImageSelectorAndUploader: React.FC<ImageSelectorAndUploaderProps> = ({ currentUrls = [], onUrlsChange, disabled = false, companyId }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="p-3 pb-0">
          <CardTitle className="text-sm font-semibold">{t('upload_new_images', { defaultValue: 'Fazer Upload de Novas Imagens' })}</CardTitle>
        </CardHeader>
