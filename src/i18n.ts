...
const resources = {
  'pt-BR': {
    translation: {
      ...
      "promotion_rules": "Regras de Segmentação",
      "promotion_rules_description": "Defina os produtos, serviços, categorias ou clientes que esta promoção irá afetar.",
      ...
      "unknown_rule_type": "Tipo de regra desconhecido",
      "add_rules_to_segment": "Adicione regras para segmentar a promoção.",
      "create_promotion": "Criar Promoção",
      "edit_promotion": "Editar Promoção",
      "loading_promotion_data": "Carregando dados da promoção...",
