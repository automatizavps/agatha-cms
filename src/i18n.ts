...
const resources = {
  'pt-BR': {
    translation: {
      ...
      "select_images_description": "Selecione imagens existentes para o produto/serviço.",
      "total_images_found": "{{count}} imagens encontradas.",
      "select_images_button": "Selecionar ({{count}})",
      "product_photos": "Fotos do Produto/Serviço",
      "product_photo": "Foto do Produto",
      "image_removed": "Imagem removida.",
      "upload_images": "Upload {{count}} Imagem(ns)",
      "select_files_to_upload": "Selecione arquivos para fazer upload.",
      ...
      // Status (for translation in reports)
